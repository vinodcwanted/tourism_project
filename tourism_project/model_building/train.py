...
# Paths to pre-split data on Hugging Face
Xtrain_path = "hf://datasets/vinodcwanted/Tourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/vinodcwanted/Tourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/vinodcwanted/Tourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/vinodcwanted/Tourism-Package-Prediction/ytest.csv"

Xtrain = pd.read_csv(Xtrain_path)
Xtest = pd.read_csv(Xtest_path)
# Read targets as 1D Series
ytrain = pd.read_csv(ytrain_path).squeeze("columns")
ytest = pd.read_csv(ytest_path).squeeze("columns")

# ---------------------------
# FEATURE DEFINITIONS (TOURISM)
# ---------------------------

# List of numerical features in the dataset (tourism-style)
numeric_features = [
    'Age',                       # Customer's age
    ...
    'Passport',                  # Whether the customer has a passport (0/1)
